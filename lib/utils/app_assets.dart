/// Contains the assets uses in the app
class AppAssets {
  /// Contains the path to the google logo image
  static String googleLogo = 'assets/imgs/g-logo-2.png';

  /// Contains the path to the avatarPlaceHolder image
  static String avatarPlaceHolder = 'assets/imgs/avatarplaceholder.png';
